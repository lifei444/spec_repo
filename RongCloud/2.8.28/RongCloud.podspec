...
Pod::Spec.new do |s|
  ...
  s.subspec 'CallLib' do |cl|
      cl.vendored_frameworks = "RongCloud/RongCallLib.framework", "RongCloud/AgoraRtcEngineKit.framework"
      ...
      cl.dependency 'RongCloud/IMLib'
  end

  s.subspec 'CallKit' do |ck|
      ck.vendored_frameworks = "RongCloud/RongCallKit.framework"
      ...
      ck.dependency 'RongCloud/CallLib'
      ck.dependency 'RongCloud/IMKit'
  end
